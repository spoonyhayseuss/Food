...
public class g_food_d_b_logFood_ActionSearchMenu extends ActivityInstrumentationTestCase2 {
    private Solo solo;
    ...
    public g_food_d_b_logFood_ActionSearchMenu() throws ClassNotFoundException {
    ...
    public void testRun() {
        ...
        solo.clickOnView(solo.getView("search"));
        solo.clickOnText("Add Quick Calories");
        solo.sleep(500);
        solo.goBack();
